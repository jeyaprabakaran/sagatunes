...
class AudioService {
  ...
  Future<void> playSong(Song song, List<Song> queue, int index) async {
    ...
    if (!kIsWeb && _audioHandler != null) {
      _audioHandler!.mediaItem.add(bg_audio.MediaItem(
        id: song.id,
...
class SagaTunesAudioHandler extends bg_audio.BaseAudioHandler with bg_audio.QueueHandler, bg_audio.SeekHandler {
    ...
    _player.playbackEventStream.listen((event) {
      ...
      playbackState.add(playbackState.value.copyWith(
        controls: [
          ...
          if (playing) bg_audio.MediaControl.pause else bg_audio.MediaControl.play,
  ...
  Future<void> onTaskRemoved() async {
    await super.stop(); // Instantly kill Android Foreground Service & Notification
    await _player.stop(); // Clean up just_audio player
